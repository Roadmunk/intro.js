   ...
   */
    ...
    // add overlay layer to the page
      ...
      // then, start the show
			...
			let skipButton     = targetElm.querySelector('.introjs-skipbutton'),
          ...
          // srcElement === ie
            ...
            // check if any callback is defined
					...
					else if (self._options.navigateOnEnter) {
  ...
  */
   ...
   */
    ...
    // remove `introjs-showElement` class from the element
		const showElement = document.querySelector('.introjs-showElement');
		if (showElement)
   ...
   */
    ...
    // check for options highlight class
      ...
      // we should wait until the CSS3 transition is competed (it's 0.3 sec) to prevent incorrect `height` and `width` calculation
        ...
        // set current step to the label
				if (oldHelperNumberLayer != null)
					oldHelperNumberLayer.innerHTML = self._options.showBlankStepNumber ? '' : targetElement.step;
      ...
      // add helper layer to target element
			...
			for (var i = 0, stepsLength = this._introItems.length; i < stepsLength; i++) {
				...
				if (this._options.canNavigateUsingBullets) {
      ...
      // add helper layer number
			if (this._options.showStepNumbers == true) {
				...
				const currentIntroItem = this._introItems[targetElement.step - 1 >= 0 ? targetElement.step - 1 : 0];
				helperNumberLayer.className = `introjs-helperNumberLayer ${currentIntroItem.helperNumberPosition || this._options.helperNumberPosition}`;
				helperNumberLayer.innerHTML = this._options.showBlankStepNumber ? '' : targetElement.step;
    ...
    // add target element position style
      ...
      // change to new intro item
		...
		let parentElm = targetElement.element.parentNode;
      ...
      // More detail: https://developer.mozilla.org/en-US/docs/Web/Guide/CSS/Understanding_z_index/The_stacking_context
		...
		if (!_elementInViewport(targetElement.element) && this._options.scrollToElement === true) {
			let rect = targetElement.element.getBoundingClientRect(),
